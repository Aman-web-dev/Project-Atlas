...
export async function updateSession(request: NextRequest) {
  ...
  // 3. Change the myNewResponse object to fit your needs, but avoid changing the status!
  // 4. Finally: return myNewResponse
  // If this is not done, you may be causing the user to be randomly logged out!
